...
/**
 * Servlet implementation class HomNay
 */
@WebServlet("/fibonaci")
public class Fibonaci extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ma==null){
			...
			List<TuVung> listTuVung = TuVungUtil.getAllTuVungFibonaci();
			request.setAttribute("listTuVung", listTuVung);
			RequestDispatcher rd=request.getRequestDispatcher("fibonaci.jsp");  
